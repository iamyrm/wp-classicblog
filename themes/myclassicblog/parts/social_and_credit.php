<div class="row s-footer__bottom">
   <div class="column lg-7 md-6 tab-12">
      <ul class="s-footer__social">
         <li>
            <a target="_blank" href="<?php echo esc_url(get_theme_mod('setting_site_details2')) ?>">
         ...
         <li>
            <a target="_blank" href="<?php echo esc_url(get_theme_mod('setting_site_details3')) ?>">
               <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                  style="fill:rgba(0, 0, 0, 1);">
                  <path
         ...
         <li>
            <a target="_blank" href="<?php echo esc_url(get_theme_mod('setting_site_details4')) ?>">
               <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                  style="fill:rgba(0, 0, 0, 1);">
                  <path
         ...
         <li>
            <a target="_blank" href="<?php echo esc_url(get_theme_mod('setting_site_details5')) ?>">
               <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                  style="fill: rgba(0, 0, 0, 1);">
                  <path
