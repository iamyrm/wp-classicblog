...
<?php if (have_posts()) : while (have_posts()) : the_post(); ?>
      <article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
         <header class="header">
            ...
            <a href="<?php echo esc_url(get_permalink($post->post_parent)); ?>" title="<?php printf(esc_attr__('Return to %s', 'ya_myclassicblog'), esc_attr(get_the_title($post->post_parent))); ?>" rev="attachment"><span class="meta-nav">&larr;</span> <?php esc_html_e('Return to', 'ya_myclassicblog'); ?> <?php echo esc_html(get_the_title($post->post_parent)); ?></a>
